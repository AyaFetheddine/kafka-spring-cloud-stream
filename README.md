...
![Spring Cloud](https://img.shields.io/badge/Spring%20Cloud-2025.1.0-blue?style=for-the-badge&logo=spring)
...
| **Spring Boot** | 4.0.1 | Framework de développement |
| **Spring Cloud Stream** | 2025.1.0 | Abstraction messaging |
...
├── 📁 src/
│   ├── 📁 main/
│   │   ├── 📁 java/ma/fetheddine/kafkaspringcloudstream/
│   │   │   ├── 📄 KafkaSpringCloudStreamApplication.java  # Point d'entrée
│   │   │   │
│   │   │   ├── 📁 events/
...
git clone https://github.com/AyaFetheddine/kafka-spring-cloud-stream.git
...
### 1️⃣ Test Kafka Console - Producer

![Kafka Console Producer](Captures/test-kafka-console-producer.png)

> **📸 Figure 1a** : Test du `kafka-console-producer` envoyant des messages au broker Kafka.

### Test Kafka Console - Consumer

![Kafka Console Consumer](Captures/test-kafka-console-consumer.png)

> **📸 Figure 1b** : Test du `kafka-console-consumer` recevant les messages, confirmant le bon fonctionnement du broker Kafka.
...
![Spring Kafka Consumer 1](Captures/test-spring-kafka-consumer1.png)

> **📸 Figure 3a** : Logs du Consumer Spring Kafka affichant les événements reçus.

![Spring Kafka Consumer 2](Captures/test-spring-kafka-consumer2.png)

> **📸 Figure 3b** : Chaque `PageEvent` est affiché avec son nom, utilisateur, date et durée dans la console.

---

### 4️⃣ Producer REST Controller - Test API

![REST Controller Test](Captures/test-kafka-producer-rest-controller.png)
...
![KStream Analytics Test 1](Captures/test-kstream-analytics1.png)

> **📸 Figure 6a** : Test du pipeline Kafka Streams complet.

![KStream Analytics Test 2](Captures/test-kstream-analytics2.png)

> **📸 Figure 6b** : Les agrégations windowed sont calculées en temps réel et stockées pour les Interactive Queries.
...
public Function<KStream<String, PageEvent>, KStream<String, Long>> kStream() {
    return (input) -> input
        ...
        .windowedBy(TimeWindows.ofSizeWithNoGrace(Duration.ofSeconds(5)))  // Fenêtre 5s
...
[![GitHub](https://img.shields.io/badge/GitHub-AyaFetheddine-181717?style=for-the-badge&logo=github)](https://github.com/AyaFetheddine)
